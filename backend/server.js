...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://reg.idcs.in', 'https://my-cricket-reg-app-zyg2.vercel.app']
    : ['http://localhost:3000', 'http://127.0.0.1:3000', 'https://reg.idcs.in','https://my-cricket-reg-app-zyg2.vercel.app'],
  credentials: true
}));
